...
| **Edge Extension** | Microsoft Edge users who want the native Edge Add-ons install path | [docs/platforms/edge.md](https://github.com/markdown-viewer/docs/blob/main/platforms/edge.md) |
...
| **Obsidian Plugin** | Vault-native preview + export on desktop and mobile | [docs/platforms/obsidian.md](https://github.com/markdown-viewer/docs/blob/main/platforms/obsidian.md) |
